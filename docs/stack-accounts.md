...
These accounts are required for Drupal image installation and configuration

## Drupal

Administrator account is set by yourselft at the time of Drupal installation wizard
